...
if (isset($_REQUEST['name'])) {
    ...
    if (hasDiscordAccount($connection, $email)) {
        die('You already have a Discord account associated with this email address. Please contact staff at 2029discordadmin@mit.edu or open a ticket to fix this.');
    }
